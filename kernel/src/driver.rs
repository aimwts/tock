...
pub trait Driver<'a> {
    ...
    fn subscribe(&self, minor_num: usize, callback: Option<Callback<'a>>, app_id: AppId<'a>) -> ReturnCode {
    ...
    #[allow(unused_variables)]
    fn command(&self, minor_num: usize, r2: usize, r3: usize, caller_id: AppId<'a>) -> ReturnCode {
        ReturnCode::ENOSUPPORT
    }
